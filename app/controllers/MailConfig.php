...
$mail->IsHTML(true);
$mail->Username = "uochelpdesk2@gmail.com";
$mail->Password = "UOChelpdesk2#";
$mail->SetFrom("uochelpdesk2@gmail.com");



function EmailContentBody($head,$salutation,$content,$emailAddress){
