  ...
  <body>
    ...
    <div class="testbox">
             ...
             <form action="../controllers/vehiclepass.php" name="vehiform" method="post" onSubmit="return validate()">
                        <div class="banner">
                          <h1>Application for Hostel Facilities(For Freshers only) University of Colombo</h1>
                        </div>
                            <div class="question">
                            ...
                            <div class="item">
                            <p>University of Colombo is not a residential University. However, very limited residential
facilities are provided. The hostel facilities will not be provided to students who come on
transfers from other Universities.</p>
      ...
      <div class="item">
        <p>G. C. E. A/L Examination Year<span class="required">*</span></p>
        <input type="text" name="year" id="year" required/>
      </div>
      <div class="item">
        <p> Index No. at GCE (A/L) Exam <span class="required">*</span></p>
        <input type="text" name="index_no" id="index_no" required/>
      </div>
      <div class="item">
