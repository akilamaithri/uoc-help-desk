...
<div class="depcard">
	...
	<div class="blog-card" onclick="location.href='ssa_home.php';">
		...
		<h1 style=" text-transform:uppercase;">Student societies</h1>
        ...
        <ul class="cards" style="width:90%">
				<li >
						...
						<div class="depCard_content" style=" border-radius:5px; border:1px solid rgb(173, 205, 206);">
					      <p class="depCard_text" style="font-size:14px; line-height:1.5">  In terms of Sections 115 and 116 of the Universities Act No.16 of 1978, as amended the recognition of Student Societies and other Associations of students in the University shall be made with the approval of the Council. During the year under review, twenty-six (26) such Students’ Societies and other Associations used functioning in the University.</p>
</div>
