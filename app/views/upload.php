...
***********************************************************/
	if (!isset($_POST['x']) && !isset($_FILES['image']['name']) ){
		//Delete users temp image
			$temppath = '../../public/img/profile_pics'.$profile_id.'_temp.jpeg';
...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/UOChelpDesk/public/img/profile_pics/';
	//Set File name	
	...
	//Move the file to correct location
		...
		if (!$move) { 
			...
			$imgSrc= "../../public/img/profile_pics/".$file_name; // the image to display in crop area
...
if (isset($_POST['x'])){
	...
	//the file type posted
		$type = $_POST['type'];	
	//the image src
		$src = '../../public/img/profile_pics/'.$_POST['src'];	
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		//save the new cropped version
			imagejpeg($dst_r, "../../public/img/profile_pics/".$finalname."n.jpeg", 90); 	
		...
		$result_path ="../../public/img/profile_pics/".$finalname."n.jpeg";

		//Insert image into database
		$insert_pic_query = mysqli_query($con, "UPDATE user SET profile_pic='$result_path' WHERE name='$userLoggedIn'");
...
<div class="main_column column" style="border:0px">
	...
	<div id="formExample" style="padding-top:100px">
	    ...
	    <form action="upload.php" method="post" class="settings_form"  enctype="multipart/form-data">
	        <h2 style="color:black">Upload your own photo</h2><br /><br />
	        <input type="file" id="image" name="image" style="width:200px; height:30px; " /><br /><br />
	        <input type="submit" value="Submit" id="save_details" style="width:100px">
	    </form><br /><br />
