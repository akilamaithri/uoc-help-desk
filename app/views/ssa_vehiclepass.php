...
<!-- whole body should be within this div -->
	...
	<div class="column-2 box" >
		...
		<ul class="cards">
			<li class="cards_item_dep" id="topic1" onclick="location.href='ssa_vehicleapp.php';">
				<div class="depCard">
        ...
        <ul class="cards" style="width:90%">
				<li >
						...
						<div class="depCard_content" style=" border-radius:5px; border:1px solid rgb(173, 205, 206);">
					      <p class="depCard_text" style="font-size:14px; line-height:1.5"> To apply for having vehicle pass you need to download the application form and submit the it with the other requested documents. </p>
</div>
